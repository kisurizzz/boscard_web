// import bg from "@/../public/images/backgrounds/page-header-bg.jpg";
// import bg2 from "@/../public/images/resources/pexels-balazsimon-15994110.jpg"
  ...
  return (
    <section className="page-header">
      <div className="page-header__top">
        <div
          className="page-header-bg"
          style={{ backgroundImage: `url(/images/resources/pexels-balazsimon-15994110.jpg)` }} // Corrected path
        ></div>
        <div className="page-header-bg-overly"></div>
        <Container>
          <div className="page-header__top-inner">
